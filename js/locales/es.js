...
(function (factory) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        pauseLabel: 'Pausar',
        pauseTitle: 'Pausar la subida en curso',
        ...
        msgUploadEnd: 'Hecho',
        msgUploadResume: 'Reanudando subida &hellip;',
        msgUploadEmpty: 'No existen datos válidos para el envío.',
        msgUploadError: 'Error de subida',
        msgDeleteError: 'Error de eliminación',
        ...
        msgImageWidthSmall: 'El ancho de la imagen "{name}" debe ser de al menos <b>{size} px</b> (se detectó <b>{dimension} px</b>).',
        msgImageHeightSmall: 'La altura de la imagen "{name}" debe ser de al menos <b>{size} px</b> (se detectó <b>{dimension} px</b>).',
        msgImageWidthLarge: 'El ancho de la imagen "{name}" no puede exceder de <b>{size} px</b> (se detectó <b>{dimension} px</b>).',
        msgImageHeightLarge: 'La altura de la imagen "{name}" no puede exceder de <b>{size} px</b> (se detectó <b>{dimension} px</b>).',
        ...
        msgDuplicateFile: 'El archivo "{name}" del mismo tamaño "{size}" ya se había seleccionado antes. Omitiendo selección duplicada.',
        msgResumableUploadRetriesExceeded:  'Subida abortada por más de <b>{max}</b> reintentos del archivo <b>{file}</b>! Detalles del error: <pre>{error}</pre>',
        ...
        fileActionSettings: {
            ...
            rotateTitle: 'Rotar 90 grados en sentido horario',
        ...
        previewZoomButtonTitles: {
            prev: 'Anterior',
            next: 'Siguiente',
            rotate: 'Rotar 90 grados en sentido horario',
